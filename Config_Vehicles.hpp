    ...
    */
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
			...
			{ "Feuerwehr", "med", {
                "textures\feuerwehr\fwelw1.paa"                
            } },
            { "Taxi", "civ", {
                "#(argb,8,8,3)color(0.6,0.3,0.01,1)"
            } },
            { "Police", "cop", {
                "textures\police\offroad_polizei.jpg"
            } }
        };
    };
...
*/
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            ...
            { "SEK", "cop", {
                "textures\police\hatchback_sek_byghost.paa"
            } },
			{ "Polizei", "cop", {
                "textures\police\hatchback_polizei.jpg"
            } },
			{ "Feuerwehr", "med", {
                "textures\feuerwehr\Feuerwehr_Limo.paa"
            } },
			{ "sani", "med", {
	...
	class I_Truck_02_box_F {
        ...
        textures[] = {
			...
			{ "Feuerwehr", "med", {
                "textures\feuerwehr\rw_fahrgestell15.paa",
                "textures\feuerwehr\rw_aufbau13.paa"
            } }            
        };
    };
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
            ...
            { "Police", "cop", {
                "textures\police\Pol-SUV.paa"
            } },
			{ "SEK", "cop", {
                "textures\police\SEK_SUV_byghost.paa"
            } },
			{ "sani", "med", {
    ...
    class C_Van_01_box_F {
        ...
        textures[] = {
            { "White", "civ", {
			 ...
			 { "RTW", "med", {
                "textures\medic\S_F_RTW1.jpg",
                "textures\medic\S_F_RTW2.jpg"
            } },
            { "Red", "civ", {
                "\a3\soft_f_gamma\Van_01\Data\van_01_ext_red_co.paa"
            } }
