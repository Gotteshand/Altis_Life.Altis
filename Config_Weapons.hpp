...
class WeaponShops {
    ...
    class rebel {
        ...
        items[] = {
			...
			{ "arifle_AK12_F", "", 1600000, -1 },
			{ "arifle_AK12_GL_F", "", 3600000, -1 },
			{ "arifle_AKM_F", "", 1600000, -1 },			
            { "arifle_SDAR_F", "", 200000, 7500 }
        };
        mags[] = {
    ...
    class cop_sergeant {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 5, "You must be a sek Rank!" };
        items[] = {
            { "hgun_ACPC2_F", "", 17500, -1 },
            { "SMG_02_ACO_F", "", 15000, -1 },
            { "arifle_MXC_F", "", 30000, -1 },			
			{ "srifle_LRR_F", "", 30000, -1 },             
			{ "arifle_AK12_F", "", 30000, -1 },
			{ "arifle_MXC_khk_F", "", 30000, -1 },
			{ "arifle_MXM_khk_F", "", 30000, -1 },
        ...
        mags[] = {
            ...
            { "30Rnd_9x21_Mag", "", 60 },			
			{ "7Rnd_408_Mag", "", 60 },
            { "30Rnd_762x39_Mag_F", "", 60 },
            { "30Rnd_65x39_caseless_mag", "", 60 },
			{ "30Rnd_65x39_caseless_mag", "", 60 },
