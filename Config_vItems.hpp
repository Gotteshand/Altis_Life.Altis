...
class VirtualShops {
    ...
    class rebel {
        ...
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge", "gagkit" };
    };
    ...
    class drugdealer {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "cocaine_processed", "heroin_processed", "marijuana", "tobacco_processed" };
    };
    ...
    class cop {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "donuts", "coffee", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit", "gagkit","lockpick" };
    };
...
class VirtualItems {
	...
	class metal_unprocessed {
        variable = "metalUnprocessed";
        displayName = "STR_Item_MetalU";
        weight = 6;
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "";
        processedItem = "metal_processed";
    };
    class metal_processed {
        variable = "metalProcessed";
